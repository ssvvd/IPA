...
export class MachinesListComponent implements OnInit, OnDestroy {
  ...
  constructor(private serv: MaterialService,private srv_machine: MachineService, private srv_statemanage: StateManagerService, private srv_appsetting:AppsettingService) {   
  }
