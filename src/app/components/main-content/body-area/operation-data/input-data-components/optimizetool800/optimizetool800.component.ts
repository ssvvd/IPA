...
@Component({
  selector: 'app-optimizetool800',
  templateUrl: './optimizetool800.component.html',
  styleUrls: ['./optimizetool800.component.scss']
})

export class Optimizetool800Component implements OnInit {
