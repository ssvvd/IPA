...
export class MainMenuComponent implements OnInit {
  ...
  {    
    ...
    this.Tabs.push (new MainTab(3,"Machining Operation","/home/machining-operation",environment.ImagePath + "icon_MachiningOp.svg",environment.ImagePath +"icon_MachiningOp_dis.svg",true));
